    ...
    <div class="container">
        ...
        <div class="card-columns mt-4">
            ...
            <div class="card text-white bg-warning border-dark" id="<?php echo $fetch['id']; ?>">
                <div class="card-img-top rounded img-thumbnail">
                    ...
                    <img class="img-fluid rounded img-thumbnail" src="<?php require_once ROOTPATH . '/activity/ActivityController.php'; $ac = new ActivityController(); echo $ac->getThumbnail(['id' => $fetch['id']]); ?>">
                </div>
                ...
                <h4 class="card-header border-dark">
                    ...
                    <div class="container-fluid">
                        <div>
                            <div class="row mt-1">
                                <a class="dropdown-item" target="_blank" href="<?php echo BASE_URL; ?>/activity/index.php?action=run&id=<?php echo $fetch['id']; ?>">
        ...
        <div class="conteiner-pagination">
            <ul class="pagination">
                ...
                <a class="page-link" href="index.php?action=viewUserActivities&user=ALL&page=<?php echo ($data['page'] - 1); ?>">
                    <li class="voltar-avancar">                
                        <img src="/SEIA/media/numero-pagina/pag-anterior.svg"></img>
                    </li>
                </a>
                ...
                <a class="page-link" href="index.php?action=viewUserActivities&user=ALL&page=<?php echo ($i + 1); ?>"><li class="page-item"><?php echo ($i + 1); ?></li></a>
