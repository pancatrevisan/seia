class RaceGame extends Instruction {
    ...
    constructor(data = { 'type': 'RaceGame', 'position': -1, 'editable': true, 'next': -1 }, activity) {
        ...
        this.editableAttributes.push(
            new AttributeDescriptor("images",['image','text','audio'],true,"<img src='/SEIA/media/icones/add_est_branco.svg'>Adicionar Estímulo para emoção",'add/remove',null,null,null,null,{'isContainer':false, 'dragAndAssociate':false, 'emotionDescriptor':"none"}),
