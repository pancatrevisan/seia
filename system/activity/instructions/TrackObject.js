class TrackObject extends Instruction{    
    constructor(data={'type':'TrackObject','position':-1,'editable':true,'next':-1}){
        ...
        this.description = "Rastreamento visual; não implementado";
        if(data==null)
            return;
        'imageId' in data?  this.imageID = data['imageID']:this.imageID =null;
    ...
    addPosition(){
        ...
        var attr = new AttributeDescriptor("images",['image'],true,"<img src='/SEIA/media/icones/add_est_branco.svg'>Adicionar Estímulo",'add/remove');
        var params = [];
        params['type'] = 'image';
