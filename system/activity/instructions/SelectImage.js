...
class SelectImage extends Instruction {
    ...
    constructor(data = { 'type': 'SelectImage', 'position': -1, 'editable': true, 'next': -1 }, activity) {/*exibe os nomes dos templates*/
        super(data,activity);
        this.allowUse = true;
        this.editableAttributes.push(
            new AttributeDescriptor("images", ['image', 'text'], true, "<img src='/SEIA/media/icones/add_est_branco.svg'>Adicionar Estímulo", 'add/remove'),
            new AttributeDescriptor("model", ['image', 'audio', 'text'], false, "<i class='fas fa-star'></i>Estímulo modelo", 'swap'),
            new AttributeDescriptor("expectedImage", ['stimulusID'], false, "<i class='fas fa-check'></i>Estímulo correto", 'swap'));
