...
<?php
    ...
    */
    ...
    require_once 'newStimuliModal.php';
?>

<style>#newStimuliTemplate {display: none;} </style>
...
<div class="corpo">
    ...
    <div class="titulo-pagina">        
        <h1>Gerar atividades do programa</h1>
    ...
    <div class="row mt-3" id="activityInfo">
        ...
        <div class="col-9" id="groups">
                ...
                <div class="col alert alert-primary">
                    <div class="row">
                        <div class="col-8">
                            <div class="row">
                                <div class="col-8">
                                    <button type="button" class="btn btn-info btn-lg btn-block" onclick="showSelectStimuli_createModal(true);">
                                        <i class="fas fa-star"></i>
                                        Selecionar Estímulo Modelo
                                    </button>
                                    <button type="button" class="btn btn-info btn-lg btn-block" onclick="showSelectStimuli_createModal(false)">
                                        <i class="fas fa-square"></i>
                                        Selecionar Estímulos de Comparação
                                    </button>
                                </div>
                            </div>
                        </div>
            ...
            <div class="row mt-2">
                <div class="row alert">
                        <div class="col input-group mb-2">
                            <p>Número de estímulos de comparação: </p>
                            <div class="col-8">
            ...
            <div class="row">
                <div class="col"> 
                    <button type="button" class="btn btn-success btn-lg btn-block" onclick="generateActivities()">
                        <img src="/SEIA/media/icones/configuracoes_branco.svg">
                        Gerar programa de ensino
                    </button> 
                </div>
            </div>
        </div>
...
<script>
    ...
    function createSelectStimuliContainer(types, showMore = true, showNew = true) {
        ...
        if (showNew) {
            ...
            newStimulusButton.id = 'newStimulusButton';
        ...
        if (showMore) {
            ...
            showMoreDiv.classList.add('container-botao');

            var showMoreButton = document.createElement('button');
            showMoreButton.classList.add('btn', 'btn-primary', 'btn-lg', 'btn-block');
            showMoreButton.innerHTML = "<img src='/SEIA/media/icones/showmore_branco.svg'>Carregar Mais Resultados";
    ...
    function addStimulus(stimuliAssocArray, model=false) {
        ...
        if (stimuliAssocArray['type'] == 'image') {
            imgStimuli = document.createElement('div');
            imgFiltro = document.createElement('div');
        ...
        imgStimuli.classList.add('card-img-top');
        imgFiltro.classList.add('filtro');
        ...
        cardButton.onclick = function () {
            ...
            but.innerHTML = "<img src='/SEIA/media/icones/excluir_branco.svg'>Remover";
        ...
        cardBody.appendChild(imgStimuli);
        imgStimuli.appendChild(imgFiltro);
        imgStimuli.appendChild(stimuli);
...
<!-- busca -->
<div class="row mt-4 d-none" id="filterFormTemplate" hidden>
...
<div class="corpo" id="gerarAtv">
    <div class="container">
        <h2>Estímulo modelo:</h2>
        <div id="modelStimulus" class="alert alert-info card-columns"></div>

        <h2>Estímulos de comparação:</h2>
        <div id="selectedStimuli" class="alert alert-warning card-columns"></div>
    </div>
</div>
