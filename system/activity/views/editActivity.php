...
<div hidden id="newStimuliModal"><?php require_once 'newStimuliModal.php'; ?></div>
    ...
    function waitForLoad() {
        if (activity != null) {
            if (activity.isReady()) {
                ...
                for (i = 0; i < activity.instructions.length; i++) {
                    ...
                    if (inst.editable) {
                        ...
                        var card =
                            ...
                            '<a href="javascript:showEditor(' + inst.position + ')" class="btn btn-outline-info btn-lg ">' + "<img src='/SEIA/media/icones/editar_branco.svg'>Editar" + '</a>' +
                            '</div>';
                ...
                document.getElementById('editableInstructions').innerHTML = "<h3>Carregando dados...</h3>";
...
<div class="corpo" id="newActivityTemplate">
    ...
    <div class="row mt-3 " id="activityInfo">
        <div class="col">
            ...
            <div class="row alert alert-primary m-2">
                <div class="col-sm-2">
                    <div class="col-sm-6 form-group">
                        <input class="form-control" type='text' id="activityName" name='activityName' placeholder="Nome da Atividade:" value="<?php echo $data['activity_name']; ?>">
                    </div>
                </div>
            ...
            <div class="row alert alert-primary m-2 ">                
                <div class="col">
                    <button id="tourSave" type="button" class="btn btn-info btn-lg btn-block" onclick="saveActivity('save')">
                        <img src="/SEIA/media/icones/salvar_alteracoes.svg"></img>
                        <p>Salvar Alterações</p>
                    </button>
                </div>
                <div class="col">
                    <button id="tourAsNew" type="button" class="btn btn-info btn-lg btn-block" onclick="saveActivity('asNew')">
                        <img src="/SEIA/media/icones/salvar_como_nova_atividade.svg"></img>
                        <p>Salvar como Nova Atividade</p>
                    </button>
                </div>
                <div class="col d-none">
                    <button type="button" class="btn btn-info btn-lg btn-block" onclick="saveActivity('asTemplate')">
                        <p>Salvar como template</p>
                    </button>
                </div>
                <div class="col ">
                    <button id="tourCancelar" type="button" class="btn btn-info btn-lg btn-block" onclick="window.location = 'index.php';">
                        <img src="/SEIA/media/icones/cancelar_branco.svg"></img>
                        <p>Cancelar</p>
                    </button>
                </div>
                <div class="col">
                    <button id="tourPreview" type="button" class="btn btn-info btn-lg btn-block" onclick="saveActivity('preview')">
                        <img src="/SEIA/media/icones/minhas_atividades_branco.svg"></img>
                        <p>Visualizar</p>
                    </button>
                </div>
            </div>
...
<script>
    ...
    function hideEdit() { document.getElementById('edit').style.display = "none"; }
    ...
    /**********************NEW**************************************/
    function editAttribute(instruction, attr_descriptor) { /*abre o modal p selecionar o estimulo*/
    ...
    function createSelectStimuliContainer(types, instruction, attr_descriptor, showMore = true, showNew = true) {
        ...
        buttonContainer.classList.add('col-column');
        ...
        if (showNew) {
            ...
            newStimulusButton.innerHTML = "<img src='/SEIA/media/barra_pesquisa/adicionar_branco.svg'>Adicionar Novo estímulo";
            newStimulusButton.onclick = function() {
                createNewStimuli(types);
            };

            all.appendChild(buttonContainer);
            buttonContainer.appendChild(newStimulusButton);
        ...
        if (showCreateNewText) {
            ...
            newTextButton.innerHTML = "<img src='/SEIA/media/icones/texto_branco.svg'>Adicionar Novo Texto";
            newTextButton.onclick = function() {
                addNewText(instruction, attr_descriptor);
            };

            all.appendChild(buttonContainer);
            buttonContainer.appendChild(newTextButton);
        }
        ...
        if (showMore) {
            ...
            showMoreDiv.classList.add('col-12');
            var showMoreButton = document.createElement('button');
            showMoreButton.classList.add('btn', 'btn-primary', 'btn-lg', 'btn-block');
            showMoreButton.innerHTML = "<img src='/SEIA/media/icones/showmore_branco.svg'>Mostrar mais";
    ...
    */
    ...
    function addStimulus(stimuliAssocArray, instruction, attr_descriptor, local = false) {        
        ...
        cardh4.classList.add('card-header');
        ...
        stimuliContainer = document.createElement('div');
        stimuliContainer.classList.add('card-img-top');

        filtro = document.createElement('div');
        filtro.classList.add('filtro');

        cardButton.onclick = function() { /*exibe o estimulo no canvas*/
        ...
        cardBody.appendChild(stimuliContainer);
        stimuliContainer.appendChild(filtro);
        stimuliContainer.appendChild(stimuli);        
        cardBody.appendChild(cardh4);
        cardh4.appendChild(cardTitle);
    ...
    function addNewText(instruction, attr_descriptor) { /*adiciona texto*/
    ...
    function createNewStimuli(types) { /*exibe modal p criar novo estimulo*/
    ...
    <form hidden id='emotionDescriptorTemplate' class="d-none">
        <div class='form-row'>
    ...
    <img hidden id="_lixeira" src="<?php echo BASE_URL . "/ui/excluir.svg"; ?>">
    <img hidden id="_redim" src="<?php echo BASE_URL . "/ui/redim.svg"; ?>">
    ...
    <!-- busca -->
    <div hidden class="row mt-4 d-none" id="filterFormTemplate">
    ...
    <div id="edit" class="row d-none">
        <div id='buttonContent' class='bg-light row h-100 w-100 border-bottom m-0 p-0 border-dark'>
            <h3 id="editInstructionName" class="col-lg-11 font-weight-bold"></h3>
            <div class='col-lg font-weight-bold'>
                <button id="closeEditor" type="button" class="close" aria-label="Close" onclick="hideEdit()">
                    <img src="/SEIA/media/icones/cancelar_branco.svg">
                </button>
            </div>
        </div>

        <div id="content" class="row p-0 h-100 w-100 p-3">
            <div id='controls' class="col-lg-4"></div>
            ...
            <div id="canvasPanel" class="m-0 p-0 col-lg-8 h-100 w-100 ">
                ...
                <canvas class="m-0 p-0" id="drawCanvas" width="800" height="600" style="border: 4px solid #adb7ca; border-radius: 5px;">
                </canvas>
            </div>            
        </div>
    </div>
