<!--pagina para criar um novo estímulo-->
...
<script>
    ...
    <div class="corpo" id="newStimuliTemplate">

        <div class="titulo-pagina">        
            <h1>Adicionar novo estímulo</h1>

            <div class="texto"><div class="barra-horizontal"></div></div>

        </div><!--titulo pagina-->

        <form enctype="multipart/form-data" autocomplete="off" action="" method="post" id="form" class="form-professional">
            <input hidden required type="text" class="form-control" id="modal" name="modal" value="modal">
            
            <div class="form-group">
                <label class="label-cadastro" for="stimuli_name">Nome:</label>
            ...
            <div class="form-group">
                <label class="label-cadastro" for="stimuli_category">Categorias (separadas por espaços):</label>
            ...
            <div class="input-estimulos">            
                <div class="form-group">
                    ...
                    <select onchange="modal_changeType()"class="form-control" id="stimuli_type" name="stimuli_type">
                        ...
                        <option value="image"><p>Imagem</p></option>
                        <option value="audio"><p>Áudio</p></option>
                    </select>
                </div>

                <div class="input-group mb-3">
                    <div class="input-group-prepend">
                        <div class="input-group-text"><input type="checkbox" aria-label="Checkbox for following text input" id="publicStimuli" name="publicStimuli"></div>
                    </div>

                    <div class="input-group-append">
                        <span class="input-group-text">
                            <p>Compartilhar publicamente?</p>
                            <p>ATENÇÃO: Todos usuários poderão visualizar o estímulo. Por favor use estímulos livres (<a target="_blank" href="https://pixabay.com/">pixabay.com</a>)</p>
                        </span>
                    </div>
                </div>
            </div><!--input estimulos-->
