...
<div class="corpo">
    ...
    <div class="titulo-pagina">        
        ...
        <div class="texto"><p class="texto-conteudo">Crie uma nova atividade a partir de um template pré-existente ou crie um novo template com a ajuda de um auxiliar.</p></div>
    </div><!--titulo pagina-->

    <div class="barra-pesquisa" id="pesquisa-templates">
        ...
        <form autocomplete="off" class="form mt-1" action="index.php?action=selectTemplate&groupId=<?php echo $data['groupId']; ?>" method="post">
            ...
            <div class="card-columns" id="card-templates">
                ...
                <?php while ($fetch = mysqli_fetch_assoc($res)) { ?>
                    ...
                    <div class="card border-dark">
                        ...
                        <div class="card-body">
                            ...
                            <span class="badge badge-secondary"><p><?php echo $fetch['antecedent']; ?></p></span>
                            
                            <!--<a href="" class="card-text"><?php echo $fetch['category']; ?></a>-->
                            <a id="<?php echo $fetch['id']; ?>" href="index.php?action=newFromTemplate&templateId=<?php echo $fetch['id']; ?>&groupId=<?php echo $data['groupId']; ?>" class="btn btn-dark">
                                <div class="botao-templates">
                                    <p>Começar</p>
                                </div>
                            </a>
...
<!--pagination -->
    <div class="conteiner-pagination">                        
        ...
        <ul class="pagination">
            ...
            <a class="page-link" href="page-item"><a class="page-link" href="index.php?action=selectTemplate&query=<?php echo $query; ?>&page=<?php echo ($i + 1); ?>">
            ...
            <a class="page-link" href="index.php?action=selectTemplate&query=<?php echo $query; ?>&page=<?php echo ($data['page'] + 1); ?>">
                <li class="voltar-avancar">
                    <img src="/SEIA/media/numero-pagina/prox-pag.svg"></img>                        
                </li>
            </a>
