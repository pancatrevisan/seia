<!--pagina para editar o curriculo-->
...
<div class="corpo row mt-3" id="programacoes">
    <div class="container">
        <div class="row row-2">
            ...
            <div class="col-3">
                <div class="card text-white bg-secondary" id="<?php echo $fetch['id']; ?>">
                    ...
                    <div class="row">
                        <div class="col">
                            <img class="img-fluid rounded bg-light" src="<?php echo BASE_URL;?>/data/student/<?php echo $fetch['id'];?>/<?php echo $fetch['avatar'];?>">
                        </div>
                    </div>                      
            ...
            <div class="student-tools">                
                ...
                <?php if($athena == 'false'){?>
                    ...
                    <div class="row alert alert-warning">
                        <div class="col">
                            <button type="button" id="addActivityButton" class='btn btn-lg btn-block btn-outline-success' onclick="openSelectProgram()">
                                <a><img src="/SEIA/media/barra_pesquisa/adicionar_branco.svg">Adicionar Programação</a>
                            </button>

                            <button>
                                <a href="<?php echo BASE_URL?>/sessionProgram/index.php?action=runCurriculum&studentId=<?php echo $fetch['id']; ?>" class="btn btn-block btn-success border border-dark"><img src="/SEIA/media/icones/minhas_atividades_branco.svg">Iniciar Ensino</a>
                            </button>
                        </div><!--col-->
                    </div><!--row-->

                    <?php } else if($athena == 'true'){ ?>
                        ...
                        <div class="row alert alert-warning">
                            <div class="col">
                                ...
                                <button>
                                    <a href="<?php echo BASE_URL?>/sessionProgram/index.php?action=runCurriculum&athena=true&studentId=<?php echo $fetch['id']; ?>" class="btn btn-block btn-success border border-dark">Visualizar Programa de Ensino</a>
                                </button>
                            </div><!--col-->
                        </div><!--row-->
        ...
        <div class="row" id="sessionHTMLTemplate">
            <div class="col-8">
                
                <div class="titulo">
                    <div class="circulo-azul"></div>
                    <p id="sessionHTMLName"></p>
                </div>

                <?php if($athena == 'false'){?>

                    <div class="programacao-opcoes">

                        <button class="btn btn-block btn-lg btn-info"id="sessionHTMLOption"><i class="fas fa-bars"></i></button>

                        <button class="btn btn-block btn-lg btn-info"id="sessionHTMLup"><img src="/SEIA/media/icones/seta_cima_branco.svg"></button>
                        
                        <button class="btn btn-block btn-lg btn-info" id="sessionHTMLdown"><img src="/SEIA/media/icones/seta_baixo_branco.svg"></button>

                        <button class="btn btn-block btn-lg btn-danger" id="sessionHTMLremove"><img src="/SEIA/media/icones/excluir_branco.svg"></button>

                    </div><!--programacao-opcoes-->
    ...
    function selectProgram(query = "") {
        ...
        xhr.onreadystatechange = function() {
            ...
            if (this.status == 200) {
                ...
                var c =
                '<div class="card">'+                
                '<h4 class="card-title"><p class="titulo-card">'+ obj[i]['name'] + '</p></h4>'+
                '<div class="card-body">'+
