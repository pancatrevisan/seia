<!--pagina para adicionar nova programação-->
            ...
            if (this.status == 200) {
                ...
                for (i = 0; i < obj.length; i++) {
                    var card =
                        ...
                        '</div>' +
                        '<button data-act-name="' + obj[i]['name'] + '" data-actId="' + obj['id'] + '" type="button"  id="selButton" class="btn btn-block btn-primary">Selecionar</button>' +
                        '</div>';
            ...
            <div class='row'>
                <div class='col-12'>
                    <button id="buttonShowMoreTemplate" type="button" class="btn btn-block btn-primary">
                        <img src="/SEIA/media/icones/showmore_branco.svg">Mostrar mais
                    </button>
                </div>
            </div>
        </div>       
        ...
        <div id="activityConfigTemplate" class="row collapse" hidden>
            <div class="col-9">
                <div class="row alert alert-info">
                    ...
                    <div class="form-group d-none" id="selectReinforcerTemplate">
                        <div>
                            <button id="selReinforcerButtonTemplate" class="form-control btn btn-info" type="button">Selecionar</button>
                ...
                <div class="row alert alert-info">
                    <div class="col">
                        <p>Consequência de erro</p>
                        <div class="col-8">
                            <select id="correctionTypeTemplate" class="form-control" onchange="correctionChange(this)">
                                <option value='none' selected>Nenhum</option>
                                <option value='repeat'>Repetir</option>
                                <option value='tip'>Dica</option>
                                <option disabled value='bad_reinforcer'>Apresentar consequência negativa (indisponível)</option>
                            </select>
                        </div><!--col-8-->
                    </div><!--col-->

                    <div class="col" id="tipTemplate">
                        <div>
                            <p>Selecione a dica</p>
                            <div class="col-8">
                    ...
                    <div class="col" id="repeatTemplate">
                        <div>
                    ...
                    <div class="form-group" id="selectBadReinforcerTemplate">
                        <div>
                            <button id="selBadReinforcerButtonTemplate" class="form-control btn btn-info" type="button">Selecionar</button>
                ...
                <div class="row alert alert-info" id="afterCorrectionTemplate">

                    <button class="btn btn-warning" onclick="showTipForTip()" hidden><i class="fas fa-question"></i></button>
            
                    <div class="col">
                        <p>Próxima atividade (acerto após correção)</p>
                ...
                <div class="row alert alert-info">
                    <div class="col">
                        <p id="nextAfterCorrectionWrongTemplateLabel">Próxima atividade em caso de erro (erro após apresentação de dica)</p>
                ...
                <div class="row alert alert-danger" id="nextOnErrorDiv_template">
                    <div class="col">
                        <p>Próxima atividade (erro): </p>
...
<div class="corpo" id="programacoes">
    <div class="container">
        <div class="row row-2 mt-3">
            <div class="col-3">
                <div class="card text-white bg-secondary">                    
                    ...
                    <div class="card-body">
                        <h4><p class="card-header border-dark titulo-card"><?php echo $fetch['name']; ?></p></h4>
        ...
        <div class="titulo-pagina">        
            <h1>Adicionar nova programação</h1>
        ...
        <div class="row">
            <div class="col-9">
                ...
                <div class="col-block">
                    ...
                    <div>
                        <input disabled type="checkbox" class="form-check-input" id="useGlobalConfig" onchange="">
            ...
            <div class="col-9" id="sessionProgram">
                <a class="btn btn-lg btn-block btn-success" href="<?php echo BASE_URL; ?>/sessionProgram/index.php?action=runSessionProgram&athena=false&session_id=<?php echo $data['sessionId']; ?>&student_id=<?php echo $data['student_id']; ?>">
                    <button><img src="/SEIA/media/icones/minhas_atividades_branco.svg">Iniciar Programa</button>
                </a>
                ...
                <div class='row' class="mt-3 mb-3 pb-3">
                    <div class='col'>
                        <button type="button" id="addActivityButton" class='btn btn-lg btn-block btn-outline-success' onclick="openSelectActivity()">
...
<script>
    function addActivityToHTML(activity_object) {
        ...
        var tituloCol = document.createElement('div');
        tituloCol.classList.add('titulo');

        var pCol = document.createElement('p');
        pCol.innerHTML = activity_object['name'];
        ...
        numCol.classList.add('circulo-azul');
        numCol.innerHTML = activity_object['position'];
        ...
        config.innerHTML = '<i class="fas fa-bars"></i>';
        ...
        down.onclick = function() { moveACtivityDown(this.getAttribute('data-activity-id')); }
        ...
        down.innerHTML = '<img src="/SEIA/media/icones/seta_cima_branco.svg">';
        ...
        nameCol.appendChild(tituloCol);
        nameCol.appendChild(progOptions);
        tituloCol.appendChild(numCol);
        tituloCol.appendChild(pCol);
        progOptions.appendChild(config);
            ...
            if (activities[i].nodeType == Node.ELEMENT_NODE) {
                if (activities[i].id != activityId) {
                    var card =
                        ...
                        '<div class="card-body">' +
                        '<div class="card-img-top"><div class="filtro"><img src="' + activities[i].getAttribute('data-activity-thumbnail') + '" alt="Card image cap"></div>' +
                        '<h4 class="card-header"><p class="titulo-card">' + activities[i].getAttribute('data-activity-name') + '</p></h4>' +
                        '</div>' +                        
                        '<a type="button" href="javascript:setNextActivity(\'' + activityId + '\',\'' + input_id + '\',\'' + activities[i].getAttribute('data-activity-id') + '\',\'' + activities[i].getAttribute('data-activity-name') + '\')" class="btn btn-outline-info btn-lg ">Selecionar</a>' +                        
                        '</div>';
    ...
    function selectActivity(query = "") {
        ...
        xhr.onreadystatechange = function() {
            ...
            if (this.status == 200) {
                ...
                for (i = 0; i < obj.length; i++) {
                    var card =
                        '<div class="card bg-light" id="' + obj[i]['id'] + '">' +
                        '<div class="card-body">' +
                        '<div class="card-img-top rounded img-thumbnail"><div class="filtro"></div><img src="' + obj[i]['thumb'] + '"></div>' +
                        '<h4 class="card-header"><p class="titulo-card">' + obj[i]['name'] + '</p></h4>' +
                        '<span class="badge badge-secondary">' + DIFFICULTY[obj[i]['difficulty']] + '</span>' +
                        '</div>' +
                        '<a href="javascript:addActivity(\'' + obj[i]['id'] + '\')" class="btn btn-block btn-primary">Selecionar</a>' +
