class PositionImages extends Instruction{   
    ...
    constructor(data={'type':'PositionImages','position':-1,'editable':true,'next':-1}){
        ...
        this.editableAttributes.push(
                ...
                new AttributeDescriptor("images",['image'],true,"<img src='/SEIA/media/icones/add_conteiner.svg'>Adicionar conteiner de imagens",'add/remove',null,null,null,'positions'),
