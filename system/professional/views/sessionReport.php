...
<div class="corpo row mt-3" id="programacoes">
    <div class="container">
        ...
        <div class="row row-2">
            <div class="col-3">
                <div class="card text-white bg-secondary" id="<?php echo $student_data['id']; ?>">
                    <div class="row">
                        <div class="col">
        ...
        <div class="row alert alert-light border" role="alert"><!--informações sobre a sessão-->
            <div class="col-9" id='sessionDescription'>
                <h2>Sessão</h2>
            </div>
            <div class="col-9">
        ...
        <div class="container-2">
            ...
            <button onclick="askToRemoveRegitry()" class= "btn btn-lg btn-block btn-danger" id="seila">
        ...
        <div class="row alert border" role="alert">
            <div class='col' id="trials"></div>
        </div>

        <div class="row d-none mt-2 border border-dark" id="trialTemplate" hidden>
            <div class="col">
                <div class ="row">
                    <div class='col-4' id="trialNameTemplate">Nome da trial</div>
                    <div class="col-2" id="trialStartDateTemplate">Início</div>
                    <div class="col-2" id="trialEndDateTemplate">Fim</div>
                    <div class="col-2" id="trialResultTemplate">Resultado</div>
...
<script type="text/javascript">
    ...
    document.body.onload = function() {
        ...
        xhttp.onreadystatechange = function() {
            ...
            '<div class="col"><p>Aplicador: </p><div class="col-8"><input disabled="" class="form-control" value="' + res['professional_id'] + '"></div></div><div class="col"><p>Data início: </p><div class="col-8"><input disabled="" class="form-control" value="' + data.toLocaleDateString() + '"></div></div><div class="col"><p>Horário: </p><div class="col-8"><input disabled="" class="form-control" value="' + data.toLocaleTimeString() + '"></div>';


                var nameRow = document.createElement("div");
                nameRow.classList.add('row', 'alert', 'border');

                nameRow.innerHTML = '<div class="col"><p>Programa: </p><div class="col-8"><input disabled="" class="form-control" value="' + res['program_name'] + '"></div>';
