...
<div class="container">
    ...
    <div class="header-titulo" id="pagina-inicial">
        ...
        <div class="col-10">
            <div class="container">
                ...
                <a href="<?php echo BASE_URL . "/activity";?>" class="btn btn btn-block btn-warning border border-dark">
                    <div class="card bg-light" id="tutoAtividades">
                        <div class="card-body">
                            <div class="card-header">
                                <h2>Minhas atividades<div class="barra-horizontal"></div></h2>
                            </div>
                            <p class="card-text">Crie ou edite as atividades criadas por você, ou aquelas criadas pela comunidade e adicionadas aqui do Repositório.</p>
                        </div><!--card-body-->

                        <img src="/SEIA/media/vetores/minhas_atividades.svg" class="img-inicial">
                    </div>
                </a><!--atividades-->

                <a href="<?php echo BASE_URL . "/stimuli";?>" class="btn btn btn-block btn-primary border border-dark">
                    <div class="card bg-light" id="tutoEstimulos">
                        <img src="/SEIA/media/vetores/meus_estimulos.svg" class="img-inicial">
                        ...
                        <div class="card-body">  
                            ...
                            <p class="card-text">Visualize estímulos adicionados por você, ou aquelas adicionados do Repositório.</p>
                        </div><!--card-body-->
                    </div>
                </a><!--estimulos-->
                        
                <a href="index.php?action=student" class="btn btn btn-block btn-danger border border-dark"> 
                    <div class="card bg-light" id="tutoEstudantes">                            
                        <div class="card-body">
                            ...
                            <p class="card-text">Visualize ou cadastre novos estudantes.</p>
                        </div>

                        <img src="/SEIA/media/vetores/estudantes.svg" class="img-inicial">
                    </div>
                </a><!--estudantes-->                        
                    
                <a href="<?php echo BASE_URL . "/activity/index.php?action=reinforcementIndex";?>" class="btn btn-success  btn-block border-dark">
                    <div class="card  bg-light" id="tutoReforcos">
                        <img src="/SEIA/media/vetores/reforcos.svg" class="img-inicial">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">Crie ou edite suas Consequências, ou aquelas adicionadas do Repositório.</p>
                        </div>
                    </div>
                </a><!--consequencias-->

                <a href="<?php echo BASE_URL . "/activity/index.php?action=userTemplateIndex";?>" class="btn btn-info btn-block border-dark">
                    <div class="card bg-light" id="tutoTemplates">
                        <div class="card-body">
                            <div class="card-header">
                                <h2>
                                    Meus Templates
                            ...
                            <p class="card-text">Visualize as atividades criadas pela comunidade.</p>
                        </div>

                        <img src="/SEIA/media/vetores/meus_templates.svg" class="img-inicial">
                    </div>
                </a>
                        
                <!--a href="<?php echo BASE_URL . "/activity/index.php?action=repository";?>" class="btn btn-info  btn-block border-dark">
    ...
    <div class="container">
        ...
        <div class="row mt-3 mb-3">
            <div class="col-2 bg-secondary p-3" hidden>
                <div class="row" >
                    <div class="col">
            ...
            <?php 
                if(isGodMode()){
            ?>
                <div id='athena' class="athena-icon">
                    <a class='btn btn-block btn-lg ' title="Modo 'deus'" href="<?php echo BASE_URL;?>/athena">
                        <img alt="Modo 'deus' " width="56px" class="img-rounded" src="<?php echo BASE_URL;?>/ui/athena.png"/>
                    </a>
                </div>
            <?php
                }
...
<!--script>
    var tuto_finished = "<?php echo $_SESSION['tuto_finished'];?>" == "0" ;
