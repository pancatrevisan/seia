<!--pagina para editar as avaliações-->
...
<div class="corpo row mt-3" id="programacoes">
    <div class="container">
        ...
        <div class="row row-2"><!--infos do estudante-->
            <div class="col-3">
                ...
                <div class="card text-white bg-danger border-dark" id="<?php echo $fetch['id']; ?>">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">Endereço: <?php echo $fetch['city'];echo " - " . $fetch['state'];?></p>
            ...
            <div class="student-tools">
                <div class="row alert alert-warning">
                    <div class="col">
                        <button data-toggle="tooltip" data-placement="right" onclick="previewGroup('', '<?php echo $programId; ?>')" id='runProgram' class="btn btn-lg btn-outline-light btn-success" type="button">
                            <a>
                ...
                <!--
                <a href="<?php echo BASE_URL;?>/program/index.php?action=newAutoProgram&programId=<?php echo $programId;?>&type=MTS" class="mt-2 btn btn-block btn-lg btn-warning border border-dark" type="button">Gerar Programa de MTS automaticamente (beta)</a>
                -->

        <div class="col-9" id="groups"></div>

            <div id='help'>
                <button class='btn btn-block btn-lg btn-warning' onclick="showHelp()"><i class="fas fa-question"></i></button>
            </div>

        <!-- configuracao dos grupos ou programa de ensino -->
        <div class="col-9" id="col9">
            <form id="configGroupOrProgramTemplate">
                <div id="abc_data" class="d-none">
                    <div class="row alert">
                        <div class="col">
                            <p>Antecedente:</p>
                            <div class="col-8">
                                <input id='groupAntecedent' type="text" class="form-control" value="">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row alert">
                        <div class="col">
                            ...
                            <div class="col-8">
                                <input id='groupBehavior' type="text" class="form-control" value="">
                            </div>
                    </div>
                </div><!--abc-data-->
                
                <div id="activity_order" class="d-none">
                    <div class="row alert alert-primary">
                        <div class="col">
                            <p>Ordem das atividades:</p>
                            <h6>Define a ordem em que as atividades do programa de ensino serão apresentadas para o estudante</h6>
                        </div>

                        <div class="col">
                            <select class="form-control custom-select mr-sm-2" id="groupActivityOrder">                            
                ...
                <div class="d-none">
                    <div class="row alert alert-primary mt-4">
                        <div class="col">
                            <p>Consequência (acerto):</p>
                            <h6>Apresentar alguma consequência em caso de acerto?</h6>
                        </div>
                    ...
                    <div class="mt-2 row d-none" id="groupChooseCorrect">
                        <div class="col">
                            <div class="col-8">
                                ...
                                <button id="selectGroupReinforcement" type="button" class="btn btn-primary  btn-block">Selecionar o estímulo</button>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="d-none">
                    <div id="correctFrequency">
                        <div class="row alert alert-primary mt-4">
                            <div class="col">
                                <p>Frequência de exibição da Consequência (acerto):</p>
                    ...
                    </div><!--correctFrequency-->

                    <div class="mt-4 row d-none" id="groupReinforcementFrequencyValue" >
                        <div class="row alert alert-primary mt-4">
                            <div class="col">
                                <p>Apresentar a consequência a cada quantos acertos:</p>
                                <div class="col-8">
                                    <input class="form-control" id="groupNumRepeatCorrection" type="number" min="1" value="1">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="d-none">
                    <div class="row alert alert-primary mt-4">
                        <div class="col">
                            <p>Consequência (erro):</p>
                            <h6>Alguma consequência em caso de erro?</h6>
                        </div>
                    ...
                    <div class="row alert alert-primary mt-4 row d-none" id="groupWrongRepeat">
                        <div class="col">
                            <p>Número de repetições:</p>
                            <div class="col-8">
                                <input class="form-control" id="groupWrongRepeatValue" type="number" min="1" value="1">
                            </div>
                        </div>
                    </div>

                    <div class="row alert alert-primary mt-4 row d-none" id="groupWrongTip">
                        <div class="col">
                    ...
                    <div class="row alert alert-primary mt-4 row d-none" id="groupWrongRepeatAndCorrect">
                        <div class="col">
                            <p>Número de acertos consecutivos:</p>
                            <div class="col-8">
                                <input id="groupWrongRepeatAndCorrectValue" class="form-control" type="number" min="1" value="1">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="row alert alert-primary">
                    <div class="col">
                        <p>Categoria (matemática, leitura, cor, etc...)</p>
                        <div class="col-8">
        ...
        <form id='configGroupActivityTemplate' class="container" hidden="">
            ...
            <div class="row alert alert-primary mt-4 d-none" id="wrongRepeat">
                <div class="col">
                    <p>Número de repetições:</p>
                    <div class="col-8">
                        <input id="numRepeatCorrection" class="form-control" type="number" min="1" value="1">
                    </div>
                </div>
            ...
            <div class="row alert alert-primary mt-4 d-none" id="wrongRepeatAndCorrect" >
                <div class="col">
                    <p>Número de acertos consecutivos:</p>
                    <div class="col-8">
                        <input id="numCorrectRepeat" class="form-control" type="number" min="1" value="1">
                    </div>
                </div>
            </div>
        ...
        <div class="row p-3 border mb-2" id="groupTemplate" hidden="">
            <div class="col">
                <div class="row">
                    <h1 id='descriptionTemplate'>Descrição do Programa de Atividades</h1>
                
                    <div class="col-8">
                        <div class="row">
                            <div class="col-8">
                                <button id='showContentTemplate' class="btn btn-block btn-lg btn-secondary plus_" type="button" data-toggle="collapse" data-target="#collapseTemplate" aria-expanded="false" aria-controls="collapseTemplate">
                                    <i class="fa fa-bars"></i>
                                </button>

                                <button id='configureGroupTemplate' class="d-none btn btn-block btn-lg btn-secondary" data-toggle="tooltip" data-placement="right" type="button">
                                    <img src="/SEIA/media/icones/configuracoes_branco.svg">
                                    Configurar o programa
                                </button>

                                <button id='previewTemplate' class="btn btn-block btn-lg btn-success" type="button" data-toggle="tooltip" data-placement="right">
                                    <img src="/SEIA/media/icones/minhas_atividades_branco.svg">
                                    Pré-visualizar o programa
                                </button>

                                <button id='removeTemplate' class="btn btn-block btn-lg btn-danger" type="button" data-toggle="tooltip" data-placement="right">
                                    <img src="/SEIA/media/icones/excluir_branco.svg">
                                    Remover o programa
                                </button>
                            </div>
                        </div>
        ...
        <form class="form-row" id='newGroupTemplate' hidden>
            <div class="form-group col-md-3"><label for='groupName'>Nome do Programa</label></div>

            <div class="form-group col-md-9"><input required class="form-control mr-sm-2" id="groupName" name="groupName" type="text"></div>
            
            <div class="form-group col-md-3"><label for='groupAntecedent' >Antecedente</label></div>

            <div class="form-group col-md-9"><input required class="form-control mr-sm-2" id="groupAntecedent" name="groupAntecedent" type="text"></div>

            <div class="form-group col-md-3"><label for='groupBehavior' >Resposta Esperada</label></div>

            <div class="form-group col-md-9"><input required class="form-control mr-sm-2" id="groupBehavior" name="groupBehavior" type="text"></div>
            
            <div class="form-group col-md-3"><label for='groupConsequence' >Consequência</label></div>

            <div class="form-group col-md-9"><input required class="form-control mr-sm-2" id="groupConsequence" name="groupConsequence" type="text"></div>

            <div class="form-group col-md-3"><label for='groupCategory' >Categoria (matemática, leitura, cor, ...)</label></div>

            <div class="form-group col-md-9"><input required class="form-control mr-sm-2" id="groupCategory" name="groupCategory" type="text"></div>
        </form>

        <div id='activityContainerTemplate' hidden>
            <div class="barra-pesquisa">
                <div class="form-group col-lg-11" id="pesquisar">
            ...
            <div class='row'>
                <div class='col-12'>
                    <div id='activityContainerContent' class='card-columns'></div>
                </div>
            </div>
            ...
            <div class='row'>
                <div class='col-12'>
                    <button id="buttonShowMoreTemplate" type="button" class="btn btn-block btn-primary">
                        <img src="/SEIA/media/icones/showmore_branco.svg">
                        Mostrar mais
                    </button>
                </div>
            </div>
        </div><!--activityContainerTemplate-->
    </div><!--container-->
</div><!--corpo-->
...
<script> /* groupActivity Configuration.*/
            ...
            if (this.status == 200) {
                ...
                for (i = 0; i < obj.length; i++) {
                    var card = //'<div class="card bg-light" id="' + obj[i]['id']+ '">' +
                            '<div class="card-img-top rounded img-thumbnail"><div class="filtro"></div><img src="' + obj[i]['thumb'] + '"></div>' +
                            '<h4 class="card-header"><p class="titulo-card">' + obj[i]['name'] + '</p></h4>' +
                            '<div class="card-body">' +
...
<script>
    function addActivityToGroupHtml(obj, group, activity) {
        ...
        var progOptions = document.createElement('div');
        progOptions.classList.add('programacao-opcoes');
        ...
        down.innerHTML = '<img src="/SEIA/media/icones/seta_baixo_branco.svg">';
        ...
        var viewEdit = document.createElement('button');
        viewEdit.innerHTML = '<img src="/SEIA/media/icones/editar_branco.svg">';
        ...
        titulo.appendChild(circulo);
        titulo.appendChild(name);
        col8.appendChild(progOptions);        
        //row.appendChild(antecedent);
        //row.appendChild(behavior);
        //row.appendChild(consequence);
        progOptions.appendChild(viewEdit);
        //row.appendChild(config);
        progOptions.appendChild(up);
        progOptions.appendChild(down);
        progOptions.appendChild(remove);
    ...
    function addGroup(name, id, obj = null) {
        ...
        if( (obj==null) || ("auto" in obj && obj['auto']!=1) ){
            ...
            button.setAttribute('data-title', null);
            button.innerHTML='<img src="/SEIA/media/icones/configuracoes_branco.svg">Gerar atividades do programa';
