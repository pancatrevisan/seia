...
<div class="col">
    <div class="container">
        <h2 class='jumbotron'>Uma nova senha foi enviada para o e-mail cadastrado (<?php echo $data['user_email'];?>) <br>
        Você pode utilizar esta nova senha para realizar o <a href="index.php"> login</a>
    </h2>
