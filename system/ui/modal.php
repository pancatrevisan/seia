<div id="modal" class="modal fade bd-example-modal-xl" tabindex="-1" role="dialog" >
    <div id="modal-dialog " class="modal-dialog modal-xl " role="document" >                
        <div class="modal-content" id="modal-content">
            ...
            <div class="fechar-modal" onclick="closeModal()">
            ...
            <div class="modal-header">
                ...
                <button style="font-size: 36pt;" type="button" class="close text-danger" data-dismiss="modal" aria-label="Close" onclick="closeModal()" hidden>
            ...
            <div class="modal-footer">
                ...
                <button id="modal-cancel"type="button" class="btn btn-secondary" data-dismiss="modal" onclick="closeModal()" hidden>Cancelar</button>
            </div>
        </div><!--modal-content-->
    </div><!--modal-dialog-->
</div><!--modal-->
